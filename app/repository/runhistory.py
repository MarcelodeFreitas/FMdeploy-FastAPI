...
def get_current(user_email: str, db: Session):
    ...
    run_history = db.query(models.RunHistory, models.User, models.Project, models.InputFile, models.OutputFile ).where(models.RunHistory.fk_user_id == user_id).outerjoin(models.User).outerjoin(models.Project).outerjoin(models.InputFile).outerjoin(models.OutputFile).with_entities(models.RunHistory.run_history_id ,models.RunHistory.flagged, models.RunHistory.flag_description, models.RunHistory.timestamp, models.RunHistory.fk_input_file_id, models.RunHistory.fk_output_file_id, models.User.email, models.User.name, models.Project.project_id, models.Project.title, models.Project.description, models.InputFile.name.label('input_file_name'), models.InputFile.path.label('input_file_path'), models.OutputFile.name.label('output_file_name'), models.OutputFile.path.label('output_file_path')).all()
    if not run_history:
